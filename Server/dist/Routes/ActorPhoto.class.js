...
var ActorPhoto = /** @class */ (function (_super) {
    ...
    function ActorPhoto() {
        ...
        _this.routeName = "ActorPhoto";
        _this.dbName = "actors";
        return _this;
    }
    ActorPhoto.prototype.Get = function (req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var id, pathToProfilePhoto, _b;
    ...
    ActorPhoto.prototype.Post = function (req, res) {
        throw new Error("Method not implemented.");
    };
    ActorPhoto.prototype.Patch = function (req, res) {
        throw new Error("Method not implemented.");
    };
    ActorPhoto.prototype.Delete = function (req, res) {
        throw new Error("Method not implemented.");
    };
    return ActorPhoto;
}(Route_class_1.Route));
