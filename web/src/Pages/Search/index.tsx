...
const Search: FunctionComponent<SearchProps> = props => {
  ...
  <Filter<Title> FilteredItemsState={filteredItems}  FilterTags={x as Array<{ variable_name: keyof Title; name: string; type: string; options?: Array<string>; }>}/>
 ...
 <PageSelector totalPageNumber={15}/>
  </div>
  </div>
<Footer />
<Navbar/></>);
